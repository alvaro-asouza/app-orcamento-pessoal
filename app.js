...
class Bd {
    ...
    recuperarTodosRegistros() {
        ...
        for (let i = 1; i <= id; i++) {
            ...
            //nestes casos nos vamos pular esses índices
            if (despesa === null) {
                continue
            }
...
function cadastrarDespesa() {
    ...
    if (despesas.validarDados()) {
        ...
        document.getElementById('modal_descricao').innerHTML = 'Erro na gravação, verifique se todos os dadoes foram preenchidos corretamente'
